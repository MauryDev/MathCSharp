...
namespace ExcelApp
{
    ...
    public class BigFloat : IComparable, IComparable<BigFloat>, IEquatable<BigFloat>
    {
        ...
        public BigFloat(float value) : this(value.ToString("N99", System.Globalization.NumberFormatInfo.InvariantInfo))
        {
        }
        public BigFloat(double value) : this(value.ToString("N99",System.Globalization.NumberFormatInfo.InvariantInfo))
        {
        }
        public BigFloat(decimal value) : this(value.ToString("N99", System.Globalization.NumberFormatInfo.InvariantInfo))
        {
        }
